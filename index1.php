    ...
    <div class="container">
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            <li><a href="employee_home.php">Employee</a></li>
            <li><a href="leave.php">Leave/s</a></li>
            <li><a href="employee_salary.php">Income</a></li>
          </ul>
        </nav>
      </div><br>
      ...
      <div class="jumbotron">
        <h1>Welcome <?php echo $_SESSION['username']; ?></h1>
	     <h2> Now you can check your leave details, employee details and salary</h2>             
      </div>
